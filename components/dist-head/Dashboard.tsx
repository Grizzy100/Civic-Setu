  ...
  return (
    <DashboardLayout>
      <div className="p-8 grid grid-cols-3 grid-rows-[auto_1fr_auto] gap-8">
        <PageHeader 
          title="Dashboard"
          description="Monitor and manage city issues in real-time"
        />
        ...
        <div className="col-span-3 relative bg-surface-glass glass-effect border border-white/20 p-6 rounded-2xl shadow-lg">
          ...
          <h3 className="text-2xl font-bold text-text-primary mb-4">Completed Works Progress</h3>
          <div className="flex items-center gap-8">
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-4">
              <div>
                <h4 className="font-semibold text-text-secondary">Total Works</h4>
                <p className="text-2xl font-bold text-text-primary">1,500</p>
              </div>
              <div>
                <h4 className="font-semibold text-text-secondary">Completed</h4>
                <p className="text-2xl font-bold text-status-success">1,275</p>
              </div>
              <div>
                <h4 className="font-semibold text-text-secondary">In Progress</h4>
                <p className="text-2xl font-bold text-status-warning">150</p>
              </div>
              <div>
                <h4 className="font-semibold text-text-secondary">Pending</h4>
                <p className="text-2xl font-bold text-status-error">75</p>
              </div>
            </div>
          </div>
        </div>
